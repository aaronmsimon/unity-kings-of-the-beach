    ...
    public class BlockAngle : MonoBehaviour
    {
        ...
        private void BlockInitiated(Vector3 contactPoint) {
            ...
            if (strongBlock) {
                ...
                ballInfo.SetSpikeTarget(GetBlockTargetPos(contactPoint, bounceDir, targetDistance), blockDuration, null, StatTypes.Block);
            } else {
                ...
                ballInfo.SetSpikeTarget(GetBlockTargetPos(contactPoint, bounceDir, targetDistance * powerReduction), blockDuration, null, StatTypes.Block, blockHeight);
            }
